...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $usid  = $connection->real_escape_string($_POST['usid']);
    ...
    // Preparing SQL query
    $sql = "INSERT INTO users (user_id,firstname, lastname, email, username, password, telephone, activation_code) VALUES ('$usid','$fname','$lname','$email', '$username', '$password','$telephone','$activation_code')";
